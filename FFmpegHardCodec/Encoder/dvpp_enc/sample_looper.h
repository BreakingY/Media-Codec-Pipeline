...
class HmevLooper {
public:
    HmevLooper(int32_t size, int32_t timeout, int device); // fix

    HmevLooper(int32_t size, int device); // fix

    HmevLooper(const char* looperName, int32_t size, int32_t timeout, int device); // fix

    HmevLooper(const char* looperName, int32_t size, int device); // fix
