...
typedef struct {
    void (*encDateOutProcess)(uint32_t channelId, void* buffer, void *arg); // fix void *arg
    // fix
    void *arg;
} VencCallback;
...
extern int32_t venc_mng_create(IHWCODEC_HANDLE* encHandle, VencParam* encParam,int device_id); // fix
